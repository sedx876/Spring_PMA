...
insert into employee (employee_id, first_name, last_name, email) values (10, 'Sharon', 'Watkins', 'swatkins876@gmail.com');
...
insert into project (project_id, name, stage, description) values (1004, 'Social Media Site Build', 'NOTSTARTED', 'How many are we Going to have working on this?');
...
insert into project_employee (employee_id, project_id) values (10,1004);
